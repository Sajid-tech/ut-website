...
const Craft = () => {
  ...
  const paperTypes = [
    {
      ...
      image: "https://images.unsplash.com/photo-1603712725038-e9334ae8fbc8?w=500"
    },
    {
      id: 2,
      ...
      image: "https://images.unsplash.com/photo-1581093458791-8a0a1d59b6d3?w=500"
    },
    {
      id: 3,
      name: "Fluting Medium",
      ...
      image: "https://images.unsplash.com/photo-1581093458878-49a5f3d8aa6b?w=500"
    },
    {
      id: 4,
      ...
      image: "https://images.unsplash.com/photo-1558036117-15e82a2c9a9a?w=500"
    }
  ];
  ...
  const itemVariants = {
    hidden: { y: 2, opacity: 0 }, // 2rem = 32px
    visible: {
      y: 0,
      opacity: 1,
      transition: {
  ...
  return (
    <>
      {/* Hero Section */}
      <section className='relative w-full pt-20 pb-16'> {/* 20rem = 320px, 16rem = 256px */}
        <div className="container">
          <motion.div 
            className='flex flex-col lg:flex-row items-start gap-12' // 12rem = 192px
            variants={containerVariants}
            initial="hidden"
            animate="visible"
          >
            <div className='flex-1 flex flex-col gap-8'> {/* 8rem = 128px */}
              <motion.div variants={itemVariants}>
                <h1 className='text-4xl md:text-5xl font-medium text-gray-900 dark:text-white leading-tight mb-4'> {/* 4rem = 64px */}
                  Premium Craft Paper
              ...
              <motion.div 
                className='grid grid-cols-3 gap-4' // 4rem = 64px
            ...
            <motion.div 
              ...
              variants={itemVariants}
            >
              <div style={{ height: '24rem' }}> {/* 24rem = 384px */}
                <img 
            ...
            >
              <div className='grid gap-6'>
                ...
                <div className='grid grid-cols-2 gap-6'>
                  ...
                  <div style={{ height: '12rem' }}>
                    <img 
                      src="https://images.unsplash.com/photo-1581093458791-8a0a1d59b6d3?w=400" 
                      alt="Quality Control"
                      className='w-full h-full object-cover'
                    />
                  </div>
