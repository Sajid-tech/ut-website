        ...
        <div className='container p-3'>
          <nav
            className={`flex items-center py-3 px-4 justify-between ${
              sticky
                ? ' rounded-md shadow-md   shadow-purple-900 bg-white dark:bg-dark_black'
                : null
            } `}>
            <div role='button' onClick={()=>navigate('/')} className='flex items-center gap-2'>
              <Logo /> 
       <span>       <span className='text-xl md:text-3xl w-full   font-bold'>THE UNITED TRADERS </span>(Regd.)</span>
            </div>
