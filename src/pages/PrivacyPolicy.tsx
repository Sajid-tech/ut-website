...
const PrivacyPolicy = () => {
  ...
  return (
    <section>
    <div
        className="relative w-full pt-56 2xl:pb-20 pb-10  before:absolute before:w-full before:h-full before:bg-gradient-to-r before:from-blue_gradient before:via-white before:to-yellow_gradient before:rounded-full before:top-24 before:blur-3xl before:-z-10 dark:before:from-dark_blue_gradient dark:before:via-black dark:before:to-dark_yellow_gradient dark:before:rounded-full dark:before:blur-3xl dark:before:-z-10"
    >
        <div className="container relative z-10">
            <div className='flex flex-col gap-5'>
                ...
                <div className="bg-white mt-10 dark:bg-dark_black p-8 rounded-2xl">
                    <p className="">
                    ...
                    <div className="my-6">
                        ...
                        <p className="mt-6 ">
                            ...
                            <Link to="https://getnextjstemplates.com/" className="text-dark_black">(https://getnextjstemplates.com/)</Link>. We refer to their Privacy Statement <Link to="https://getnextjstemplates.com/" className="text-dark_black">(https://getnextjstemplates.com/)</Link>.
                        </p>
                    ...
                    <div className="my-6">
                        ...
                        <p className="mt-6 ">
                            ...
                            <Link to="https://www.paddle.com/" className="text-dark_black">(https://getnextjstemplates.com)</Link>. We refer to their Privacy Statement <Link to="https://www.paddle.com/" className="text-dark_black">https://getnextjstemplates.com/</Link>.
                        </p>
                    </div>
                </div>
            </div>
